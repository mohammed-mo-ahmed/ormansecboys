...
export const getGalleryPhotos = async (): Promise<GalleryItem[]> => [
  ...
  },
  {
    id: '6',
    type: 'map',
    url: '/images/gallery/5.png', // thumbnail يظهر في الـ grid
    embedSrc:
  ...
  { id: '9',  type: 'image', url: '/images/gallery/8.jpg',  title: { ar: '', en: '' } },
  { id: '10', type: 'image', url: '/images/gallery/9.jpg',  title: { ar: '', en: '' } },
  { id: '11', type: 'image', url: '/images/gallery/10.jpg', title: { ar: '', en: '' } },
  { id: '12', type: 'image', url: '/images/gallery/11.jpg', title: { ar: '', en: '' } },
];
