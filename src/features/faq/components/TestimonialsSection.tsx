  ...
  <section className="mb-20">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      {testimonials.map(testimonial => {
        const name = testimonial.name[locale] || testimonial.name['ar'] || testimonial.name['en'] || '';
        const role = testimonial.role[locale] || testimonial.role['ar'] || testimonial.role['en'] || '';
        const content = testimonial.content[locale] || testimonial.content['ar'] || testimonial.content['en'] || '';
          ...
          >
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-[#0652ba]">{role}</p>
              </div>
            </div>
            ...
            <p className="text-gray-600 leading-relaxed relative z-10">{content}</p>
          </div>
        );
      })}
    </div>
