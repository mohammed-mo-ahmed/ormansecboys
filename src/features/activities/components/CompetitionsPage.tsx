...
export const CompetitionsPage = async () => {
  const [competitions, locale, t] = await Promise.all([
    getCompetitions(),
    getLocale(),
      ...
      <div className="max-w-7xl mx-auto px-4 space-y-12">
        ...
        <div className="space-y-6">
          {competitions.map(comp => (
            <div
              key={comp.id}
              className={`bg-white p-8 rounded-xl shadow-lg border-s-4 border-[#0652ba] hover:shadow-xl transition-all`}
            >
