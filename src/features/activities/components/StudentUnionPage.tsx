      ...
      <div className="max-w-7xl mx-auto px-4 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
            ...
            <h3 className="text-2xl font-bold mb-4 text-gray-900">{t('responsibilities.title')}</h3>
            <ul className="space-y-3 text-gray-600">
              {responsibilities.map((item, i) => (
                <li key={i} className="flex items-start gap-2">
                  <span className="text-[#0652ba] font-bold mt-0.5">•</span>
                  {item}
                </li>
              ))}
            </ul>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {SU_IMAGES.map(img => (
            <div key={img.src} className="relative h-64 rounded-xl overflow-hidden shadow-md">
        ...
        <div className="bg-[#0652ba] text-white py-6 text-center rounded-xl">
          <p className="flex items-center justify-center gap-3 flex-wrap">
            ...
            <a href="https://www.facebook.com/profile.php?id=100088099876007" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-white text-[#0652ba] px-4 py-2 rounded-lg font-semibold hover:bg-gray-100 transition-all">
