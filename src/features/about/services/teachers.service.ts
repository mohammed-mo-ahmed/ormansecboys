...
export const getTeachers = async (): Promise<Teacher[]> => [
  { id: '1',  name: { ar: 'أ.أسماءإسماعيل', en: 'Ms. Asmaa Esmail' }, subject: { ar: 'مديرة المدرسة', en: 'School Principal' }, image: '/images/teachers/ms.asmaa-esmail.webp' },
  ...
  { id: '3',  name: { ar: 'أ. أحمد طارق', en: 'Mr. Ahmed Tarek' }, subject: { ar: 'اللغة العربية', en: 'Arabic Language' }, image: '/images/teachers/unknown.webp' },
  ...
  { id: '18', name: { ar: 'أ. كريم عبدالله', en: 'Mr. Karim Abdullah' }, subject: { ar: 'الرياضيات', en: 'Mathematics' }, image: '/images/teachers/unknown.webp' },
  ...
  { id: '22', name: { ar: '', en: '' }, subject: { ar: 'الأحياء', en: 'Biology' }, image: '/images/teachers/unknown.webp' },
  ...
  { id: '25', name: { ar: '', en: '' }, subject: { ar: 'الجغرافيا', en: 'Geography' }, image: '/images/teachers/unknown.webp' },
  ...
  { id: '30', name: { ar: '', en: '' }, subject: { ar: 'علوم الحاسوب', en: 'Computer Science' }, image: '/images/teachers/unknown.webp' },
  ...
  { id: '36', name: { ar: '', en: '' }, subject: { ar: 'اللغة الإسبانية', en: 'Spanish Language' }, image: '/images/teachers/unknown.webp' },

  { id: '37', name: { ar: '', en: '' }, subject: { ar: 'التربية الزراعية', en: 'Agricultural Education' }, image: '/images/teachers/unknown.webp' },

  { id: '38', name: { ar: '', en: '' }, subject: { ar: 'التربية الصناعية', en: 'Industrial Education' }, image: '/images/teachers/unknown.webp' },

  { id: '39', name: { ar: '', en: '' }, subject: { ar: 'التربية الرياضية', en: 'Physical Education' }, image: '/images/teachers/unknown.webp' },

  { id: '40', name: { ar: '', en: '' }, subject: { ar: 'التربية العسكرية', en: 'Military Education' }, image: '/images/teachers/unknown.webp' },

  { id: '41', name: { ar: '', en: '' }, subject: { ar: 'التربية الفنية', en: 'Art Education' }, image: '/images/teachers/unknown.webp' },
