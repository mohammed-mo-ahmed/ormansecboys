...
export const getTeachers = async (): Promise<Teacher[]> => [
  // 1. الإدارة المدرسية
  { id: '1', name: { ar: 'أ. أسماء اسماعيل محمد', en: 'Ms. Asmaa Esmail' }, subject: { ar: 'مديرة المدرسة', en: 'School Principal' }, image: '/images/teachers/ms.asmaa-esmail.webp' },
  ...
  // 6. المواد الأدبية (التاريخ والجغرافيا)
  ...
  // 8. اللغات الثانية (ألماني / فرنسي / إيطالي / إسباني)
  ...
  // 9. الحاسب الآلي وتكنولوجيا المعلومات
  ...
  // 10. الأنشطة والمجالات (زراعة ومجال صناعي)
  ...
  // 11. التربية الرياضية والفنية والموسيقية
  ...
  // 12. الخدمات التربوية (الأخصائيين والمكتبة والإعلام)
