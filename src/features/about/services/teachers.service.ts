...
export const getTeachers = async (): Promise<Teacher[]> => [
  { id: '1',  name: { ar: 'أ.أسماءإسماعيل',                  en: 'Ms. Asmaa Esmail'                  }, subject: { ar: 'مديرة المدرسة',       en: 'School Principal'       }, image: '/images/teachers/ms.asmaa-esmail.jpg' },
  ...
  { id: '16', name: { ar: 'أ. محمود طه',               en: 'Mr. Mahmoud Taha'            }, subject: { ar: 'الرياضيات',          en: 'Mathematics'             }, image: '/images/teachers/unknown.jpg' },
  ...
  { id: '21', name: { ar: 'أ. فوزي صدقي',              en: 'Mr. Fawzy Sedky'             }, subject: { ar: 'الكيمياء',           en: 'Chemistry'               }, image: '/images/teachers/unknown.jpg' },
  ...
  { id: '43', name: { ar: 'أ. فاطمة الزهراء كامل',     en: 'Ms. Fatma El-Zahraa Kamel'  }, subject: { ar: 'إدارة المكتبة',     en: 'Library Management'      }, image: '/images/teachers/unknown.jpg' },
];